package com.zhudao.springboot.japi;
...
public class TestJApiDocs {
    ...
    public static void main(String[] args) {
        ...
        config.setProjectPath("/Users/zhudao/Java/SpringBoot-base/lab-24/doc-japi"); // 项目所在目录
        config.setDocsPath("/Users/zhudao/Downloads/"); // 生成 HTML 接口文档的目标目录
